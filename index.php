  ...
  <body class="front-page transparent-header">
    ...
    <div class="page-wrapper">
      ...
      <div class="header-container">
        ...
        <!-- ================ -->
        <header class="header dark fixed fixed-desktop clearfix d-none">
          <div class="container">
            <div class="row">
              <div class="col-md-auto hidden-md-down">
                ...
                <div class="header-first clearfix">
                  ...
                  <div id="logo" class="logo">
                    <a href="index.html"><img id="logo_img" src="images/logo_green.png" alt="Nomad Tax"></a>
                  </div>
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="navbar-brand clearfix hidden-lg-up">
                      ...
                      <div id="logo-mobile" class="logo">
                        <a href="index.html"><img id="logo-img-mobile" src="images/logo_light_blue.png" alt="Nomad Tax"></a>
                      </div>
                            ...
                            <li>
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-3 hidden-md-down">
                                  ...
                                  <p class="mb-2">Nomad Tax is perfectly suitable for corporate, business and company webpages.</p>
                                  <img src="images/section-image-3.png" alt="Nomad Tax">
                                </div>
                              </div>
                            </li>
                          </ul>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="fullscreen-slide">
                <div class="background-image" style="background-image:url('nomadtax/background-4.jpg');"></div>
                <div class="background-image-overlay"></div>
                <div class="container">
                  <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                    <h1 class="text-white text-capitalize animated fadeInDown hc-animation-delay-1000">Nomad Tax</h1>
                    <p class="animated fadeInUp hc-animation-delay-1250">Guiding digital nomads through tax landscapes.
            ...
            <div class="carousel-item">
              <div class="fullscreen-slide">
                <div class="background-image" style="background-image:url('nomadtax/background-2.jpg');"></div>
                <div class="background-image-overlay"></div>
                <div class="container">
                  <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                    <h1 class="text-white text-capitalize animated fadeInDown hc-animation-delay-1000">Beyond the numbers</h1>
                    <p class="animated fadeInUp hc-animation-delay-1250">
                      At Nomad Tax, we’re not your average numbers nerds.  Founded, built and run by digital nomads, we have a unique understanding of the complex business and personal tax situations encountered in this lifestyle.
                    </p>
            ...
            <div class="carousel-item">
              <div class="fullscreen-slide">
                <div class="background-image" style="background-image:url('nomadtax/background-3.jpg');"></div>
                <div class="background-image-overlay"></div>
                <div class="container">
                  <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="overlay-container overlay-visible">
                    <img src="nomadtax/pino-3.jpg" alt="">
                    <div class="overlay-bottom hidden-xs">
                      <div class="text">
                        <h3 class="title">Krystal Pino - Founder & CPA </h3>
                      </div>
                    </div>
                    <a href="nomadtax/about_pino-2.jpg  " class="popup-img overlay-link d-none" title="image title"><i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- section -->
      <!-- ================ -->
      <section class="pv-30 light-gray-bg padding-bottom-clear d-none">
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-lg-8">
