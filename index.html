              ...
              <div class="fullscreen-slide">
                ...
                <div class="container">
                  <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                    ...
                    <p class="animated fadeInUp hc-animation-delay-1250">Guiding digital nomads Through the tax landscape
              ...
              <div class="fullscreen-slide">
                ...
                <div class="container">
                  <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                    ...
                    <p class="animated fadeInUp hc-animation-delay-1250">At We’re not your average numbers nerds.
                    <br class="d-none d-sm-inline">
                    Founded, built and run by digital nomads
                    <br class="d-none d-sm-inline">
                    <small>
                      We have a unique understanding of the {complex} business and personal
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="main col-12">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <p>I decided to start Nomad Tax after noticing that there was a gap in the market between US based and expatriate taxpayers, the space occupied by the growing number of digital nomads.  As a digital nomad myself..</p>
                ...
                <div class="col-lg-6">
                  <div class="overlay-container overlay-visible">
                    <img src="nomadtax/about_pino-2.jpg" alt="">
        ...
        <div class="space-bottom">
          <div class="slick-carousel carousel">
            <div class="image-box hc-shadow text-center">
              <div class="overlay-container">
                <img src="nomadtax/about_nomadtax-1.jpg" alt="">
